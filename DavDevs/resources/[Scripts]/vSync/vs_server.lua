...
admins = {
    'steam:1100001163e70f8',
    'steam:11000013563871b',
}
...
RegisterCommand('freezetime', function(source, args)
    if source ~= 0 then
        if isAllowedToChange(source) then
            ...
            TriggerClientEvent('chatMessage', source, '', {255,255,255}, '^8Error: ^1Você não é permitido usar esse comando.')
        end
    else
        freezeTime = not freezeTime
        if freezeTime then
