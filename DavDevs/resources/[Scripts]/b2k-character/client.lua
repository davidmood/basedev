...
AddEventHandler("b2k-character:characterCreate",function()
	doStatus = 1
...
AddEventHandler("b2k-character:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),4,26,0,2)
		SetPedComponentVariation(PlayerPedId(),6,11,0,2)-- sapato
		SetPedComponentVariation(PlayerPedId(),8,15,0,2)
		SetPedComponentVariation(PlayerPedId(),6,16,0,2)
		SetPedComponentVariation(PlayerPedId(),11,262,0,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),0,8,2,2)
		...
		SetPedComponentVariation(PlayerPedId(),6,5,0,2)
		SetPedComponentVariation(PlayerPedId(),8,7,0,2)
		SetPedComponentVariation(PlayerPedId(),11,271,0,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
	...
	TriggerServerEvent("b2k-character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
