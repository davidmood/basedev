...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookjoins = "https://discord.com/api/webhooks/816337532408168448/gsO7xemJBWU174cn20cXkzVbGkSxz7PSMxUJVwoPowz1fehqEpD4hDVYNJAWUt_S3Gwv"
local webhookexit = "https://discord.com/api/webhooks/816337532408168448/gsO7xemJBWU174cn20cXkzVbGkSxz7PSMxUJVwoPowz1fehqEpD4hDVYNJAWUt_S3Gwv"
		...
		if user_id then
			...
			if not vRP.isBanned(user_id) then
				...
				if vRP.isWhitelisted(user_id) then
					...
					deferrals.done("Essa e uma Base de autoria do DavDevs! [ Adquira a sua DavDevs v1 ][ ID: "..user_id.." ]")
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
			else
				deferrals.done("Você foi banido! [ Para mais informações em discord.gg/ZDRawSh ] ")
				print(user_id)
				TriggerEvent("queue:playerConnectingRemoveQueues",ids)
			end
		else
