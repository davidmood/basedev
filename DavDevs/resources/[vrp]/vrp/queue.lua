...
Config.Language = {
	joining = "DavDevs Entrando...",
	connecting = "DavDevs Conectando...",
	err = "DavDevs Não foi possível identificar sua Steam ou Social Club.",
	_err = "DavDevs Você foi desconectado por demorar demais na fila.",
	pos = "DavDevs Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "DavDevs Não foi possível adiciona-lo na fila.",
    wlonly = "DavDevs Você não está aprovado na whitelist.",
	banned = "DavDevs Seu passaporte foi revogado na cidade.",
	steam = "DavDevs Você precisa estar com a Steam aberta para conectar."
}
