...
vRP._prepare("creative/add_vehicle","INSERT IGNORE INTO vrp_user_vehicles(user_id,vehicle) VALUES(@user_id,@vehicle)")
...
local garages = {
	...
	--[ GARAGEM POLICIA ]--------------------------------------------------------------
	-----------------------------------------------------------------------------------
	[16] = { ['name'] = "PETO", ['payment'] = false, ['perm'] = "peto.permissao" },
	[17] = { ['name'] = "BOPE", ['payment'] = false, ['perm'] = "bope.permissao" },
	[18] = { ['name'] = "COE", ['payment'] = false, ['perm'] = "coe.permissao" },
	[19] = { ['name'] = "HeliP", ['payment'] = false, ['perm'] = "departamento-policia.permissao" },
	[20] = { ['name'] = "OnibusP", ['payment'] = false, ['perm'] = "departamento-policia.permissao" },
	--[21] = { ['name'] = "PoliciaB", ['payment'] = false, ['perm'] = "departamento-policia.permissao" },
	--[22] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "departamento-policia.permissao" },
	--[23] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "departamento-policia.permissao" },
	--[24] = { ['name'] = "PoliciaA", ['payment'] = false, ['perm'] = "departamento-policia.permissao" },
	-----------------------------------------------------------------------------------
    --[ GARAGEM HOSPITAL ]-------------------------------------------------------------
	-----------------------------------------------------------------------------------
	[25] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "hospital.permissao" },
	[26] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "hospital.permissao" },
	[27] = { ['name'] = "Paramedico", ['payment'] = false, ['perm'] = "hospital.permissao" },
	[28] = { ['name'] = "ParamedicoH", ['payment'] = false, ['perm'] = "hospital.permissao" },
	[29] = { ['name'] = "Mecanico", ['payment'] = false, ['perm'] = "mecanico.permissao" },
	[30] = { ['name'] = "Mecanico", ['payment'] = false, ['perm'] = "mecanico.permissao" },
	[31] = { ['name'] = "Taxista", ['payment'] = false, ['perm'] = "taxista.permissao" },
	...
	[37] = { ['name'] = "Lixeiro", ['payment'] = false, ['perm'] = "livre" },
	[38] = { ['name'] = "Minerador", ['payment'] = false, ['perm'] = "livre" },
	[39] = { ['name'] = "Lenhador", ['payment'] = false, ['perm'] = "livre" },
	[40] = { ['name'] = "Leiteiro", ['payment'] = false, ['perm'] = "livre" },
	[41] = { ['name'] = "Caminhoneiro", ['payment'] = false, ['perm'] = "livre" },
	--[42] = { ['name'] = "Cargas", ['payment'] = false, ['perm'] = "livre" },
	[43] = { ['name'] = "Juiz", ['payment'] = true, ['perm'] = "juiz.permissao" },
	[44] = { ['name'] = "Advogado", ['payment'] = true, ['perm'] = "advogado.permissao" },
	[45] = { ['name'] = "Embarcações", ['payment'] = false, ['perm'] = "livre" },
	...
	[49] = { ['name'] = "Serpentes", ['payment'] = true, ['perm'] = "serpentes.permissao" },
	[50] = { ['name'] = "SerpentesBarcos", ['payment'] = true, ['perm'] = "serpentes.permissao" },
	[51] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "motoclub.permissao" },
	[52] = { ['name'] = "Motoclub", ['payment'] = true, ['perm'] = "motoclub.permissao" },
	[53] = { ['name'] = "Ballas", ['payment'] = true, ['perm'] = "ballas.permissao" },
	[54] = { ['name'] = "Vagos", ['payment'] = true, ['perm'] = "vagos.permissao" },
	[55] = { ['name'] = "Families", ['payment'] = true, ['perm'] = "families.permissao" },
	[56] = { ['name'] = "Marabunta", ['payment'] = true, ['perm'] = "marabunta.permissao" },
	[57] = { ['name'] = "Mafia", ['payment'] = true, ['perm'] = "mafia.permissao" },
	[58] = { ['name'] = "Yakuza", ['payment'] = true, ['perm'] = "yakuza.permissao" },
	[59] = { ['name'] = "Corleone", ['payment'] = true, ['perm'] = "corleone.permissao" },
	[60] = { ['name'] = "Cosanostra", ['payment'] = true, ['perm'] = "cosanostra.permissao" },
	--[61] = { ['name'] = "Corredores", ['payment'] = true, ['perm'] = "corredores.permissao" },
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[611] = { ['name'] = "Fotos", ['payment'] = false, ['perm'] = "dono.permissao" },
	[612] = { ['name'] = "Frutas", ['payment'] = false, ['perm'] = "livre" },
	[613] = { ['name'] = "Bicicletario", ['payment'] = true, ['perm'] = "livre" },
					...
					elseif parseInt(vehicle[1].detido) >= 1 then
						...
						if parseInt(os.time()) <= parseInt(vehicle[1].ipva+24*15*60*60) then
							...
							if vRP.vehicleType(tostring(name)) == "exclusive" or vRP.vehicleType(tostring(name)) == "rental" then
								...
								if ok then
									if vRP.tryFullPayment(user_id,parseInt(vRP.vehiclePrice(name)*0.03)) then
										vRP.execute("creative/set_ipva",{ user_id = parseInt(user_id), vehicle = name, ipva = parseInt(os.time()) })
										TriggerClientEvent("Notify",source,"sucesso","Pagamento do <b>Vehicle Tax</b> conclúido com sucesso.",10000)
									else
										TriggerClientEvent("Notify",source,"negado","Dinheiro insuficiente.",10000)
...
RegisterCommand('dv',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"dono.permissao") or vRP.hasPermission(user_id,"conce.permissao") then
					...
					if v.home == garages[garage].name then
						if parseInt(v.garage) == 1 then
							...
							if resultOwner[1] then
								if parseInt(os.time()) >= parseInt(resultOwner[1].tax+24*14*60*60) and (vRP.hasPermission(user_id,"platina.permissao") or vRP.hasPermission(user_id,"permanente.permissao")) and (string.find(v.home,"FH") or string.find(v.home,"LX") or string.find(v.home,"MS") or string.find(v.home,"SS")) then
...
RegisterCommand('travar',function(source,args,rawCommand)
	...
	local x,y,z = vRPclient.getPosition(source)
	if user_id then
		if vRP.hasPermission(user_id,"departamento-policia.permissao") or vRP.hasPermission(user_id,"conce.permissao") then
	...
	if user_id then
		...
		if vehicle then
			if math.random(100) >= 50 then
				local policia = vRP.getUsersByPermission("departamento-policia.permissao")
				local x,y,z = vRPclient.getPosition(source)
	...
	if user_id then
		if args[1] and parseInt(args[2]) > 0 then
			...
			if myvehicles[1] then
				if (vRP.vehicleType(tostring(args[1])) == "exclusive" or vRP.vehicleType(tostring(args[1])) == "rental") and not vRP.hasPermission(user_id,"dono.permissao") then
