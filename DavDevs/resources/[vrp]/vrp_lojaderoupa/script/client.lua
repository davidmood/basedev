...
local lojaderoupa = {
    { name = "Loja de Roupas", id = 277, x = 428.93206787109, y = -800.06951904297, z = 29.501140365601 },
    { name = "Loja de Roupas", id = 277, x = -1083.8194580078, y = -2729.783203125, z = 14.606415748596 },
    ...
    { name = "Loja de Roupas", id = 277, x = -1031.76, y = -2751.32, z = 14.6 },
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
        for k in pairs(lojaderoupa) do ---0.6,0.5,0.5,0.4,255,0,0,50,100
            DrawMarker(21, lojaderoupa[k].x, lojaderoupa[k].y, lojaderoupa[k].z-0.6, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.4, 255, 0, 0, 50, 0, 0, 0, 1)
        end
    end
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if (IsNearLojaRoupa()) then
            Citizen.CreateThread(function()
                drawTxt("PRESSIONE  ~b~[E]~w~  PARA ABRIR A LOJA",4,0.5,0.95,0.50,255,255,255,180)
