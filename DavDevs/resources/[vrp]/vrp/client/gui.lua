...
RegisterKeyMapping ( 'vrp:declinetwo' , 'Negar' , 'keyboard' , 'U' )

RegisterCommand('vrp:declinetwo', function()
    SendNUIMessage({ act = "event", event = "U" })
end, false)
...
-- RegisterKeyMapping ( 'vrp:animp3' , '[A] Beleza' , 'keyboard' , 'LEFT' )
...
-- RegisterKeyMapping ( 'vrp:animp4' , '[A] Saudação' , 'keyboard' , 'UP' )
...
-- RegisterKeyMapping ( 'vrp:animp5' , '[A] Assobiar' , 'keyboard' , 'DOWN' )
...
-- RegisterKeyMapping ( 'vrp:animp6' , '[A] Vergonha!' , 'keyboard' , 'RIGHT' )
